...
var MainInsp = inspect.NewInspector("CdnCheck", 9999)
...
func initDecoration() {
	...
	//MainInsp.SetRecordMiddleware(inspect.NewBaseMiddleware(func(record inspect.Record) inspect.Record {
	//	WriteLog(record.ToString("", false, true))
	//	return record
	//}))
}
